...
(()=>{'use strict';
 ...
 function openDecision(){if(!current||!state.revealed)return;root().querySelector('.decision-screen').classList.add('show')}
 function closeDecision(){root().querySelector('.decision-screen').classList.remove('show')}
